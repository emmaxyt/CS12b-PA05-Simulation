...
public class Country {
	...
	/**
	 * places is a 2d array representing the places a person could be each entry can
	 * contain either a Person or null
	 */
	public Person[][] places;

	/**
	 * population is an array of all people in the country this is the same set of
	 * people as in the places array
	 */
	...
	public void printStats() {
		this.getStats();
		System.out.println("infected: " + this.numInfected + "/" + this.numPeople + " recovered:" + this.numRecovered);
